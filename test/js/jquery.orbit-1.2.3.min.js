...
i+"</li>"),k.css({background:"url("+a.bulletThumbLocation+w+") no-repeat"});c.children("ul.orbit-bullets").append(k);k.data("index",i);k.mouseenter(function(){n();l(d(this).data("index"))})}A()}})}})(jQuery);
